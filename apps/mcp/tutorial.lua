...
local CONTROLS_ITEMS = {
    ...
    {text = "ark search", idx = 3},
    {text = "ark messenger", idx = 4},
    {text = "wrench: go to current app in app-console", idx = 5},
    {text = "preferences", idx = 6},
    {text = "rocket/gem build mode (fast vs thorough)", idx = 7},
    {text = "hourglass foreground/background", idx = 8},
    {text = "{} variables inspector", idx = 9},
    {text = "? help docs", idx = 10},
}
