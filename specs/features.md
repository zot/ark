...
| Managed PTY session (ark hosts Luhmann)     | Phase 1 shipping (Go CLI pty core: `ark luhmann launch`/`attach`/`status`/`stop`, fan-out multiplexer, content-free launch confirmation). Browser terminal transport + desk-lamp UI deferred to phases 2–3. | `managed-pty.md`, `.scratch/LUHMANN-MANAGED-SESSION-20260709.md` (working notes) |
