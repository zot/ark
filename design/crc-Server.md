...
- RegisterContentRoutes(): called after flib.Start() succeeds.
  ...
  - GET /content/PATH — rich HTML presentation. Markdown: HTML shell
    loading ark-markdown-editor.js with HostAPI wired to editor
    endpoints. Other types: `<pre>` block. (R1160-R1164)
