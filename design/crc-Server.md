...
- RegisterLuaFunctions(): called after flib.Start(). Uses
  ...
  - mcp:inbox(show_all) — returns Lua table of InboxEntry records
    from the tag index. Calls DB.Inbox().
