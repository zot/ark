...
- Admission-time **path-scope** filter (R3185, R3186, R3192): when
  ...
  the Searcher's own `pathMatchesGlob`, so the scope means exactly what
  `ark search -files` means (R3192). Candidates are then gated at the
